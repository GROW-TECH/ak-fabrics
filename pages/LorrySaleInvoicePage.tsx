...
const LorrySaleInvoicePage: React.FC = () => {
  const { id } = useParams();
        ...
        <div className="inv-wrap inv">
          ...
          <div style={{ borderBottom: `2px solid ${G}` }}>
            <div style={{ display: "flex", alignItems: "stretch" }}>
              ...
              {/* LEFT: Logo full height - centered and filling the box */}
              <div style={{ flexShrink: 0, borderRight: `1px solid ${G}`, display: "flex", alignItems: "center", justifyContent: "center", padding: "8px", width: 140 }}>
                <img
                  src="/AK Logo.jpg"
                  alt="AK Fabrics"
              ...
              {/* RIGHT: GSTIN + Phone */}
              <div style={{ flexShrink: 0, borderLeft: `1px solid ${G}`, padding: "6px 10px", minWidth: 150, display: "flex", flexDirection: "column", justifyContent: "center" }}>
...
export default LorrySaleInvoicePage;
